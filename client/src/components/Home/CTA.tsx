        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/login"
                className="bg-red-500 text-white rounded-full font-semibold hover:bg-red-600 hover:shadow-[0_8px_24px_rgba(239,68,68,0.35)] inline-flex items-center gap-2 text-[15px] px-10 py-4 w-full sm:w-auto justify-center"
              >
            ...
            <p className="mt-6 text-xs text-gray-400">
              Start free · No commitment · Upgrade when you need
            </p>
          </div>
        </div>
      </div>
