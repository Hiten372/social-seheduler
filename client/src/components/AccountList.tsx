...
const AccountList = ({ accounts, onDisconnect }: AccountListProps) => {
  ...
  if (accounts.length === 0) {
    return (
      ...
      border-slate-200 flex flex-col items-center justify-center py-20 px-6"
      >
        ...
        <p className="text-lg text-slate-700">No accounts connected yet</p>
        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="ml-2 p-1.5 rounde-lg text-slate-300 group-hover:text-red-500 transition-all"
            >
