  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded text-sm transition-all duration-150 border ${
                isActive
      ...
      <div className="p-4 border-t border-slate-100">
        ...
        <button
          onClick={logout}
          className="mt-1 flex items-center gap-2 w-full rounded text-sm text-slate-500 
          hover:bg-red-50 hover:text-red-500 transition-all duration-150 px-3 py-2"
        >
